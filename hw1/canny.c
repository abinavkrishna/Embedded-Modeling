...
void non_max_supp(short* mag,short* gradx, short* grady, int rows, int cols,
   ...
   int cols)
{
   ...
   int i;
   /*float thethresh;        unused variable*/
	...
	float tlow, float thigh, unsigned char *edge)
{
   ...
   hist[32768];                               /* low count, cc, rr, i are unused */
   short int maximum_mag;                     /* sumpix unused */
   ...
   ****************************************************************************/
   for(rowcount=1,magrowptr=mag+ncols+1,gxrowptr=gradx+ncols+1,
      ...
      for(colcount=1,magptr=magrowptr,gxptr=gxrowptr,gyptr=gyrowptr,
         resultptr=resultrowptr;colcount<ncols-1; 
