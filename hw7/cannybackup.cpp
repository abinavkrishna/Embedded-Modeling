...
{   
    ...
    Tstop = clock();
    clock_t Tstimulus = (double)(Tstop - Tstart)/CLOCKS_PER_SEC;
...
{   Tstart = clock();
    ...
    Tstop = clock();
    clock_t Tstimulus = (double)(Tstop - Tstart)/CLOCKS_PER_SEC;
    printf("Gaussian_smooth time = %lf\n",(double)Tstimulus);
}
...
void Apply_Hysteresis::main(void)
{
    ...
    Tstop = clock();
    clock_t Tstimulus = (double)(Tstop - Tstart)/CLOCKS_PER_SEC;
    printf("Apply_Hysteresis time = %lf\n",(double)Tstimulus);
}
