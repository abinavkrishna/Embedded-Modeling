...
#line 12 "ProdCons.sc"
class C1 : public _specc::channel, public Sender, public Receiver
{
private:
public:
...
#line 32 "ProdCons.sc"
class Producer : public _specc::behavior
{
private:
...
#line 611 "ProdCons.h"
    Producer(unsigned int _idcnt, Sender (&Port));
...
#line 46 "ProdCons.sc"
class Consumer : public _specc::behavior
{
private:
...
#line 630 "ProdCons.h"
    Consumer(unsigned int _idcnt, Receiver (&Port));
