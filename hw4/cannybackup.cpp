...
/* cannyA1_ref.c: EECS 222 solution A1 */
...
{
   char infilename[128] = "golfcart.pgm";  /* Name of the input image */
   char *dirfilename = NULL; /* Name of the output gradient direction image */
   char outfilename[128];   /* Name of the output "edge" image */ 
   char composedfname[128];  /* Name of the output "direction" image */
   unsigned char imageTemp[IMAGE_SIZE];
   unsigned char *image = imageTemp;/* input image*/
   unsigned char edgeTemp[IMAGE_SIZE];
   unsigned char *edge = edgeTemp; /* output image*/
         ...
         float tlow, float thigh, unsigned char **edge, char *fname)
{
   ...
   short int smoothedimTemp[IMAGE_SIZE],     /* The image after gaussian smoothing.      */
             delta_xTemp[IMAGE_SIZE],        /* The first devivative image, x-direction. */
             delta_yTemp[IMAGE_SIZE],        /* The first derivative image, y-direction. */
             magnitudeTemp[IMAGE_SIZE];      /* The magnitude of the gadient image.      */
   float dir_radiansTemp[IMAGE_SIZE];   /* Gradient direction image.                */
   short int *smoothedim = smoothedimTemp;
   short int *delta_x = delta_xTemp;
   short int *delta_y = delta_yTemp;
   short int *magnitude = magnitudeTemp;
   float     *dir_radians = dir_radiansTemp; 
   /****************************************************************************
...
* dy images. Because not all derivatives are computed in the same way, this
        ...
        short int **smoothedim)
{
   int r, c, rr, cc,     /* Counter variables. */
      windowsize = WINDOW_SIZE,        /* Dimension of the gaussian kernel. */
      center;            /* Half of the windowsize. */
   float tempimTemp[IMAGE_SIZE];
   float kernelTemp[WINDOW_SIZE]; 
   float *tempim = tempimTemp,        /* Buffer for separable filter gaussian smoothing. */
         *kernel = kernelTemp,        /* A one dimensional gaussian kernel. */
